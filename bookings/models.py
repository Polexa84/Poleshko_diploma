...
class Booking(models.Model):
    ...
    duration = models.DurationField(default=timezone.timedelta(hours=3), verbose_name='Длительность')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Создано')
    confirmation_token = models.UUIDField(default=uuid.uuid4, editable=False, unique=True) # Unique confirmation token
